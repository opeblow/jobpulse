...
| 2 | [Overview](#why-jobpulse) | The problem, the vision, the live app |
| 3 | [Features](#features) | Kanban board, AI inbox, AI Coach, analytics, dark mode |
| 4 | [Sponsor deep dives](#sponsor-deep-dives) | How **Convex**, **OpenAI**, **Firecrawl**, and **AgentMail** work together |
| 4.1 | [Built with Convex](#built-with-convex) | Schema, indexes, queries, mutations, actions, HTTP webhooks, real-time sync |
| 4.2 | [Built with OpenAI](#built-with-openai) | Structured extraction, email classification, AI Coach, draft-reply generation |
| 4.3 | [Built with Firecrawl](#built-with-firecrawl) | Job-posting scraping + multi-URL company-intel crawling |
| 4.4 | [Built with AgentMail](#built-with-agentmail) | Inbound webhook → classification → job matching + durable outbound sends |
| 5 | [Tech stack](#tech-stack) | Full layer-by-layer breakdown |
| 6 | [Getting started](#getting-started) | Clone, run locally, set env vars |
| 7 | [Usage](#usage) | Add jobs, forward emails, coach roles, follow up |
| 8 | [Testing](#testing) | 41-endpoint integration suite + assert-based verification |
| 9 | [Deployment](#deployment) | Deploy backend to Convex, push frontend to `convex.site` |
| 10 | [Documentation](#documentation) | Build log and community files |
| 11 | [File structure](#file-structure) | Where every Convex function and React component lives |
| 12 | [Built for the Convex All Gas Hackathon](#built-for-the-convex-all-gas-hackathon) | Hackathon context, sponsors, and "made with" credits |
